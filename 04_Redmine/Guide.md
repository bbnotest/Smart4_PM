...
> ⏱️ 전체 60~90분(설치 포함) · 💳 무료(오픈소스) · 🧰 Docker
...
| 단계 | 내용 | 시간 |
|---|---|:--:|
| [**1단계 · Redmine 띄우기**](Step1.md) | Docker로 설치·실행 (관문!) | 20분 |
| [**2단계 · 관리자 설정 & 프로젝트**](Step2.md) | 로그인·기본구성·프로젝트 | 10분 |
| [**3단계 · 이슈와 WBS**](Step3.md) | 상위/하위 이슈 | 12분 |
| [**4단계 · 버전(마일스톤)**](Step4.md) | 버전 + 로드맵 | 8분 |
| [**5단계 · 내장 간트**](Step5.md) | 날짜·진행률 → 간트 | 10분 |
| [**6단계 · 시간기록 & 마무리**](Step6.md) | 시간기록 + 셀프 체크 + 면접 | 8분 |
