...
> **Pixel Dungeon 맥락** — 게임에서 스프린트의 목표는 늘 **'직접 플레이되는 것'** 이에요. 문서나 반쪽짜리 기능이 아니라, M1 프로토타입처럼 **손으로 만져볼 수 있는 데모**를 2주마다 하나씩 내는 거죠. 보드의 '검토 중'은 게임팀에선 보통 **코드 검토나 아트 컨펌(확인)** 을 기다리는 칸으로 써요.
