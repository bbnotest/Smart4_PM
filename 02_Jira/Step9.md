...
> **Pixel Dungeon 맥락**<br>
> 운영하다 보면 똑같은 손일이 반복됩니다.<br>
> 버그에 꼬리표 달기, QA에게 넘기기, 못 끝낸 일을 다음 스프린트로 옮기기 같은 것들입니다.<br>
> 이런 걸 규칙으로 자동화해 두면 PM은 정작 중요한 콘텐츠·일정에 집중할 수 있습니다.<br>
> Trello의 'Butler'와 똑같은 개념입니다.
