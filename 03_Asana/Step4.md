...
- 상세 패널 **`Attach`**(클립 아이콘)로 기획 이미지·레퍼런스를 붙입니다.

> 🖼️ 공식 스크린샷 자리 — 서브태스크 / 상세 패널
> 출처: https://asana.com/
...
> **Pixel Dungeon 맥락** — **설명의 완료조건(AC)** 한 줄이 "다 됐다"의 기준을 통일합니다. 게임은 "재미"가 모호해서 AC가 특히 중요해요. 서브태스크는 큰 작업(던전 생성)을 **하루치 단위**로 쪼개 진척이 보이게 합니다.
