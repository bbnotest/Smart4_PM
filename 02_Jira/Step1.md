...
> **Pixel Dungeon 맥락** — 게임팀은 개발·아트·사운드·QA가 **한 보드**에서 같이 움직여요. 그래서 첫 세팅이 중요한데, **'팀이 관리'** 를 고르면 따로 관리자를 두지 않아도 **PM이 직접** '일의 단계'나 '누가 무엇을 볼지'를 바로바로 바꿀 수 있어요. 사람이 많지 않은 게임팀엔 이게 딱이에요.
