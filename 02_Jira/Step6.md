...
> **Pixel Dungeon 맥락** — 번다운이 **평평하면**, 게임 개발 특유의 **'재미를 찾느라 작업이 안 줄어드는'** 위험 신호입니다. **벨로시티**로 다음 스프린트에 콘텐츠를 얼마나 약속할지 정하고, **크런치 전에** 범위를 조정합니다.
...
**🎤 면접 한 줄**
> *"**번다운**으로 스프린트 중반 지연을 감지하고, **벨로시티 추세**로 다음 스프린트 범위를 데이터 기반으로 조정했습니다."*
...
👉 다음: **[QA · 이슈(버그) 관리](QA_Process.md)** — 실무의 마지막, **QA 프로세스**입니다.
