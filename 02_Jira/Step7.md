...
> **Pixel Dungeon 맥락** — 출시 직전 QA 기간엔 버그가 쏟아져요. 이때 **"어떻게 하면 다시 나타나는지"(재현 스텝)** 가 또렷한 버그일수록 개발이 빨리 고칩니다. PM은 '출시를 막는 치명적인 버그부터' 순서를 정하고, **버그가 QA→개발→QA로 오가는 흐름**이 중간에 막히지 않게 챙깁니다.
