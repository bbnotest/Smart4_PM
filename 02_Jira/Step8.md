...
> **Pixel Dungeon 맥락**<br>
> 출시된 게임은 이슈가 수백~수천 개까지 쌓입니다.<br>
> 이걸 매번 눈으로 찾는 대신 '이번 업데이트를 막는 것만', '내가 맡은 버그만'을 검색 한 줄로 걸러냅니다.<br>
> 그러면 매일 아침 회의나 급한 수정에 훨씬 빨리 대응할 수 있습니다.<br>
> 이렇게 저장해 둔 검색은 나중에 대시보드(10단계)에 그대로 올려 씁니다.
