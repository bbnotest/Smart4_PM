...
> 🖼️ 공식 스크린샷 자리 — 보드 운영·필터

---

## 🎮 현장 감각 — 게임 PM은 이렇게

> **Pixel Dungeon 맥락** — 보드의 카드 분포가 곧 **번다운 대용**입니다. Done이 안 늘면 위험 신호. WIP 제한은 "이것저것 동시에"를 막아 실제 완료를 늘려요. 게임팀에서 In Progress가 막히면 보통 **에셋 대기(아트)** 가 원인입니다.
