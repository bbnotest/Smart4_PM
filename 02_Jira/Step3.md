...
> 🔸 여기서 "작업"은 **계획된 개발 항목**입니다. **QA가 발견해 등록하는 버그 '이슈'** 는 결이 다른 별도 프로세스예요 → **[QA · 이슈(버그) 관리](QA_Process.md)**

---

## 🎮 현장 감각 — 게임 PM은 이렇게

> **Pixel Dungeon 맥락** — 스토리 포인트는 **시간이 아니라 상대적 복잡도**입니다. 'US-05 던전 생성(5pt)'이 'US-08 효과음(2pt)'보다 큰 이유는 **절차적 생성**이 변수가 많아서죠. 담당을 **DEV/ART로 분리**하면 병렬로 작업이 굴러갑니다.
...
**🎤 면접 한 줄**
> *"**유저 스토리** 형식으로 백로그를 작성하고, **상대적 복잡도 기반 스토리 포인트**로 추정해 스프린트 용량을 가늠했습니다."*
