...
> **Pixel Dungeon 맥락** — **간트차트**(막대 일정표)는 투자자·퍼블리셔에게 보여줄 때 **누구나 알아보는 그림**이에요. 게임은 보통 **코어 플레이 → 콘텐츠 → 다듬기** 순서로 가는데(움직이는 캐릭터가 있어야 던전도 의미가 있죠), 이 '먼저-나중' 관계를 **화살표**로 그려줍니다. M1~M4는 '여기까진 됐다'를 확인하는 **점검 지점**이고요.
