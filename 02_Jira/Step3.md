...
> **Pixel Dungeon 맥락** — **스토리 포인트**는 '며칠 걸린다'는 시간이 아니라, **'얼마나 까다로운가'를 서로 비교한 점수**예요. '던전 생성(5점)'이 '효과음(2점)'보다 점수가 높은 건, 던전을 매번 다르게 자동으로 만드는 일이 **변수가 훨씬 많아** 까다롭기 때문이에요. 그리고 개발(DEV)·아트(ART)로 담당을 나눠두면 둘이 **동시에** 일할 수 있어요.
