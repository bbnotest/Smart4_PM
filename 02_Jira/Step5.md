...
> **Pixel Dungeon 맥락** — 간트는 **투자자·퍼블리셔 보고의 공용어**입니다. 게임은 **코어 → 콘텐츠 → 폴리시** 의존성이 강해(코어 플레이 없이 던전 못 만듦) 이를 **의존성 화살표**로 보여줍니다. M1~M4는 **데모·빌드 게이트**입니다.
...
**🎤 면접 한 줄**
> *"무료 **Timeline**으로 8주 로드맵과 에픽 간 **의존성**을 시각화해 투자자 미팅용 일정 한 장을 만들었습니다."*
